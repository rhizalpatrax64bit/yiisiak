    ...
    <fieldset>
                        ...
                        <tr>
                            <td>  <?php
                                $this->widget(
                                    ...
                                    array(
                                        'name' => 'uas_'. $model->jdwl_id ,

                                        'value' =>  date("m-d-Y", strtotime($model->jdwl_uas)),
                            ...
                            <td>
                                ...
                                $this->widget(
                                    ...
                                    array(
                                        'name'        => 'Ruangan_uas'.$model->jdwl_id,
                                        'data'        => $list,
                                        'htmlOptions' => array(
                                            'id'      => 'Ruangan_uas'.$model->jdwl_id,
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $("#uas_<?=$model->jdwl_id?>").removeClass("hasDatepicker");
                $("#uas_<?=$model->jdwl_id?>").datepicker("destroy");
                $("#uas_<?=$model->jdwl_id?>").datepicker();


                $("#Ruangan_uas<?=$model->jdwl_id?>").select2({
